...
$ar_domisili = [
    "Jakarta","Bogor","Depok","Tanggerang","Bekasi","Lainya"
];
// opsi jika tidak memiliki skill akan diberi array kosong
...
// Memeriksa apakah data dikirim melalui metode POST tidak melalui get dilink
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Memeriksa apakah skill dipilih
    if(isset($_POST['skills']) && is_array($_POST['skills'])) {
        // Menambahkan nilai skill yang dipilih ke total poin
        foreach ($skill_pilihan as $selected_skill) {
...
<body>
    ...
    <div class="p-3" style="background-color: #FEFBF6; border:2px solid black;width:50vw;margin:3rem auto;font-size:1.5rem;font-weight:600">
    ...
    <div class="text-center">
        <a href="index.php">balik ke form</a>
    </div>
</body>
</html>