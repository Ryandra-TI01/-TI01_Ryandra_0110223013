...
<html lang="en">
    ...
    <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item d-none d-sm-inline-block">
						<a href="index.php" class="nav-link text-dark" id="judul_2">Admin Puskesmas</a>
					</li>
				</ul>
				<!-- Right navbar links -->
			...
			<aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #468088;">
				<!-- Brand Logo -->
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							<li class="nav-item">
								<a href="form_pasien.php" class="nav-link text-light">
							...
							<li class="nav-item">
								<a href="data_pasien.php" class="nav-link text-light">
									<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-point-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 7a5 5 0 1 1 -4.995 5.217l-.005 -.217l.005 -.217a5 5 0 0 1 4.995 -4.783z" stroke-width="0" fill="currentColor" /></svg>
									<p>Data Pasien</p>
								</a>
							</li>
